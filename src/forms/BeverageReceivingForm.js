    ...
    const renderReceivingLogItem = ({ item }) => (
        <View style={dailyStyles.tableRow} key={item.id}>
            ...
            {editMode ? (
                ...
                <Text style={[dailyStyles.dataCell, dailyStyles.tempOfBeverageCol]}>{item.tempOfBeverage}</Text>
            )}
            {editMode ? (
                <TextInput
                        ...
                        <View style={styles.docDetailsRight}>
                            <View style={styles.detailRowItem}>
                                ...
                                {editMode ? (
                                    ...
                                    <Text style={styles.detailValueInput}>{issueDate}</Text>
                                )}
                            </View>
                            <View style={styles.detailRowItem}>
                    ...
                    <View style={styles.deliveryDetails}>
                        <View style={styles.deliveryRow}>
                            ...
                            {editMode ? (
                                ...
                                <Text style={styles.deliveryInput}>{deliveryDetails.dateOfDelivery}</Text>
                            )}
                            ...
                            {editMode ? (
                                ...
                                <Text style={styles.deliveryInput}>{deliveryDetails.receivedBy}</Text>
                            )}
                            ...
                            {editMode ? (
                                ...
                                <Text style={styles.deliveryInput}>{deliveryDetails.complexManager}</Text>
                            )}
                        </View>
                        <View style={styles.deliveryRow}>
                            ...
                            {editMode ? (
                                ...
                                <Text style={styles.deliveryInput}>{deliveryDetails.timeOfDelivery}</Text>
                            )}
                            ...
                            {editMode ? (
                                ...
                                <Text style={styles.deliveryInput}>{deliveryDetails.invoiceNo}</Text>
                            )}
