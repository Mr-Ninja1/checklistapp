...
const styles = StyleSheet.create({
  ...
  tableHeader: { flexDirection: 'row', backgroundColor: '#6B7280', padding: 6, marginTop: 12, alignItems: 'center' },
  tableBorder: { borderWidth: 1, borderColor: '#ccc' },
  tableBorderRow: { borderBottomWidth: 1, borderColor: '#e6e6e6' },
  th: { color: '#fff', fontWeight: '700', padding: 8, textAlign: 'center' },
  thSmall: { color: '#fff', fontWeight: '700', padding: 6, textAlign: 'center', fontSize: 11 },
