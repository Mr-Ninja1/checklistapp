...
const DRAFT_KEY = 'bakery_underbar_chiller_temperature_log_draft_2';
const MAX_DAYS = 31;
...
const initialMeta = {
  ...
  location: 'Bakery - Underbar Chiller 2',
  hseqManagerSign: '',
  complexManagerSign: '',
  fscSign: '',
};
...
export default function Bakery_UnderbarChillerTemperatureLog2() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const payload = {
        ...
        title: 'Bakery - Underbar Chiller Temperature Log 2',
