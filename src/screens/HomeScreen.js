...
import { View, Text, TouchableOpacity, ScrollView, Image, useWindowDimensions, StyleSheet } from 'react-native';
...
>>>>>>> 41ae985375fb5cab5925f6cc686aaf0dec9fd5f8
  ...
  return (
    // note: use minHeight: '100vh' so page can scroll on web
    <View style={{ minHeight: '100vh', backgroundColor: '#f6fdff', width: '100%' }}>
      <LoadingOverlay visible={loadingCard} message={loadingMsg} />

      <TouchableOpacity
        style={[styles.historyBtn, {
          // pin to bottom/right so it doesn't affect page height/scroll
      ...
      <ScrollView
        style={{ width: '100%' }}
        // allow content to grow so ScrollView calculates correct scroll height on web
              ...
              >
                <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 8 }}>
                  <Image
                    ...
                    style={{ width: 40, height: 40, borderRadius: 12, backgroundColor: '#fff', marginRight: 12 }}
                    resizeMode="contain"
                  />
                  <View style={{ flex: 1 }}>
